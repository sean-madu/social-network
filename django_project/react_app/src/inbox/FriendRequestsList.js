        ...
        <li key={item.id} className='list-group-item'>
          <div className='container'>
            <div className='row'>
              ...
              <div className='column pt-2'>
                <p> Friend Request from {item.displayName} </p>
                <div className='btn-group' role='group'>
                  <button type="button" onClick={(e) => { handleAccept(item.id) }} class="btn btn-outline-success">
                    <span>
                  ...
                  <button type="button" onClick={(e) => { handleReject(item.id) }} class="btn btn-outline-danger">
